...
knitr::include_graphics("images/pindolaTitleSlide.png")
```
...
.center[
```{r, }
cor(rankAge, rankFat, method = "kendall")
```
]
...
# FF (4): Spureous correlation

---

# Going multivariate: Multiple correlation

---

# Going multivariate: Partial correlations
